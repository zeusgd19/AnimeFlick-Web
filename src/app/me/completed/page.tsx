            ...
            <section className="relative overflow-hidden border-b">
                ...
                <div className="relative mx-auto max-w-6xl px-4 py-8 md:py-10">
                    <div className="mb-4 flex flex-wrap items-center gap-2 text-sm text-muted-foreground">
                        ...
                        <span>/</span>
                        <span className="text-foreground">Completados</span>
                    </div>

                    <div className="flex flex-wrap items-center justify-between gap-3">
                        <div>
                            <div className="flex flex-wrap gap-2">
                                <Badge>▶️ Completados</Badge>
                            ...
                            <p className="mt-2 max-w-prose text-sm text-muted-foreground">
                                Animes que has terminado. (Paginación local por si hay muchos.)
                            </p>
                        </div>
                        ...
                        return (
                            <section className="rounded-3xl border bg-card p-6 shadow-sm">
                                <div className="flex flex-wrap items-end justify-between gap-3">
                                    <div>
                                        <h2 className="text-lg font-semibold">Lista: Completados</h2>
                                ...
                                {total === 0 ? (
                                    <div className="mt-6 rounded-2xl border bg-card p-5">
                                        <p className="text-sm font-semibold">Aún no tienes animes en “Completados”.</p>
                                        <p className="mt-2 text-sm text-muted-foreground">
                                    ...
                                    <>
                                        ...
                                        <Pagination basePath="/me/completed" query={{}} data={paginationData} />
                                    </>
                                )}
                            </section>
                        );
